...
class User(AbstractUser):
    ...
    nid = models.CharField(verbose_name='National ID', max_length=10, blank=True, null=True)
    bma = models.CharField(verbose_name='BMA Code', max_length=20, blank=True, null=True)
...
class Schedule(models.Model):
    ...
    wkfrom = models.CharField(verbose_name='Start Day', max_length=15, choices=DAYS)
    wkto = models.CharField(verbose_name='End day', max_length=15, choices=DAYS)
